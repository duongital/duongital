...
rm -rf ./src/content/random
cp -r ~/Library/Mobile\ Documents/iCloud~md~obsidian/Documents/Notebook/random ./src/content/random

rm -rf ./src/content/notes
cp -r ~/Library/Mobile\ Documents/iCloud~md~obsidian/Documents/Notebook/notes ./src/content/notes
